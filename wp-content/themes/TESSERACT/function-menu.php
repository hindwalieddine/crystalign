...
class Menu_Font_Styles{
	...
	public static function load_google_fonts()
	{
			...
			wp_register_style('googleFontsHeader','http://fonts.googleapis.com/css?family='.$header_fonts);
			...
			wp_register_style('googleFontsFooter','http://fonts.googleapis.com/css?family='.$footer_text);
...
function tesseract_old_unbranding_activate_notice() {
		echo '<div class="error"><p>Looks like you have the OLD <b>Tesseract Remove Branding</b> Plugin. You will need to upgrade to the new Tesseract Remove Branding Plugin" to get the newest features. <a href="http://tesseracttheme.com/unbranding-update/" target="_blank">Click Here</a></p></div>';
	}